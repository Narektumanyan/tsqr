...
$this->title = ($confirmed) ? Yii::t('user', 'Almost done') : Yii::t('user', 'Oops! something didn’t go right');
                ...
                <div id="message-box" class="message-box no-border"> <!--widget-box-->
                    <div class="widget-body">
                        <div class="widget-main">
                            ...
                            <p class="some-text">
                                <?= ($confirmed) ?
                                    "You have successfuly confirm your account" :
                                    "It seems you have already confirmed this account"
                                ?>
                                <br/>
                                <i><?=$email?></i>
                            </p>
