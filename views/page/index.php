...
<div id="post-categories-wp">
    ...
    <div id="post-cvategories-menu-all-wp">
        ...
        <?php else: ?>
        <div class="menu-categories-wp">
            <ul class="menu-categories">
                <li><a href="#All" class="all active" >All (0)</a></li>
                <li><a href="#Deleted" class="deleted" >Deleted (0)</a></li>
            ...
            <div class="categories-search">
                ...
                <div class="search-text-wp">
                    <?php
                    $searchPageTitle = (isset($_GET['PageSearch']['title']) &&
                        !empty($_GET['PageSearch']['title'])) ? $_GET['PageSearch']['title'] : '';
                    ?>
                    <?= Html::input("text", "textToSearch", $searchPageTitle, ['class' => 'search-post', 'placeholder' => 'Search page'])?>
                </div>
            </div>
        </div>
        <?php endif; ?>
