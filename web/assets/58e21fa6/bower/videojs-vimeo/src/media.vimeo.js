...
videojs.Vimeo = videojs.MediaTechController.extend({
  init: function(player, options, ready){
    ...
    this.el_ = videojs.Component.prototype.createEl('iframe', {
      id: this.id_,
      className: 'vjs-tech vjs-tech-vimeo',
      scrolling: 'no',
      marginWidth: 0,
      marginHeight: 0,
      frameBorder: 0,
    ...
    this.player_el_.insertBefore(this.el_, this.player_el_.firstChild);
      ...
      var $player = $(this.player_el_);

      console.log('$player', $player.data('width'), $player.data('height'));

      var normalizeSizeVideo = function (param, value) {
          var w = 12, h = 9, vW = $player.data('width'), vH = $player.data('height');
          if (vH / vW != .75){
              w = 16;
          }
          switch (param) {
      ...
      var normalizeWidth = normalizeSizeVideo('height', $player.height());
      $player.find('iframe')
          .css('height', $player.height() + 400 +'px')
      ...
      if ($(player.el_).hasClass('video-js-vimeo-dante')){
          $player.find('iframe')
            .css('left', ($player.width() - normalizeWidth) / 2 )
      }

      //console.log('this.player_el_', this.player_el_, $player.find('iframe'), $player.height(), $player.width());
