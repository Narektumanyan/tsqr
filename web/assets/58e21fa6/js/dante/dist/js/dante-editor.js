//~~~MODIFFED!!!!~~~
//parent div MUST have class page-content
(function() {
  window.Dante = {
    Editor: {
      ToolTip: {},
...
(function() {
  ...
  Dante.Editor = (function(_super) {
    ...
    Editor.prototype.handlePaste = function(ev) {
      ...
      var elem = $(ev.target);
      var text = $(ev.originalEvent.clipboardData.getData('text/html')).text();
      ...
      return _.each(elements.find("img"), (function(_this) {
        return function(image) {
          utils.log("process image here!");
	        if(!_.isUndefined(_this.uploader_widget)){
    ...
    Editor.prototype.displayTooltipAt = function(element) {
      ...
      this.tooltip_view.hide();
      if (!_.isEmpty($.trim(element.text()))) {
        return;
      }
    ...
    Editor.prototype.setupElementsClasses = function(element, cb) {
      ...
      return setTimeout((function(_this) {
        return function() {
          ...
          _this.setupFirstAndLast();
          if (_.isFunction(_this.afterInit)) {
            _this.afterInit();
          }
          if (_.isFunction(cb)) {
            return cb();
...
(function() {
  ...
  Dante.Editor.Tooltip = (function(_super) {
    ...
    Tooltip.prototype.template = function() {
      ...
      return "<button class='inlineTooltip-button control' title='Add stuff' data-action='inline-menu'> <span class='tooltip-icon icon-plus'></span> </button> <div class='inlineTooltip-menu'> " + menu + " </div>";
    };
